...
executable={
    ...
    "0":"#!/bin/bash",
    "1":"source /code/myenv/bin/activate",                                                                                                       
    "2":"export STARTPATH=/code/start.sh",                                                                                                       
    "3":"source /code/fix_xrdfs.sh",
    "4":"export X509_USER_PROXY=myproxy",                                                                                           
    "5":"export X509_CERT_DIR=/cvmfs/cms.cern.ch/grid/etc/grid-security/certificates", 
    "6":"time python runner.py",
    "7":"mv output.root mkShapes__RDF_2017_v9_emu_DNN__ALL__${1}.root"
